...
SECRET_KEY = 'a#xz+j2b*oyem)$*wc!tql27*&bhu58z-@i8^^thb0txyg_n5+'
...
INSTALLED_APPS = [
    ...
    'booking_api.core'  # .apps.CoreConfig
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR + '/booking_api/core/templates/'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        ...
        'booking_api.core.permissions.IsOwnerOrReadOnly',
    ],
